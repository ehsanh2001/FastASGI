"""
FastASGI Complete Example

This example demonstrates the core features of FastASGI:
...
# Add parent directory to path to import fastasgi
sys.path.insert(0, os.path.dirname(os.path.dirname(__file__)))

from fastasgi import FastASGI, Request, APIRouter
from fastasgi.response import text_response, json_response
from fastasgi.middleware.builtin_middleware import CORSMiddleware, ExceptionMiddleware
...
if __name__ == "__main__":
    ...
    print("🚀 Starting FastASGI Complete Example")
