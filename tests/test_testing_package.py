"""
Comprehensive tests for the FastASGI testing package.
...
class TestApp:
    """Test FastASGI application with various endpoints for testing."""
...
class LiveServerHelper:
    """Helper for managing a live FastASGI server during tests."""

    def __init__(self, app: FastASGI, host: str = "127.0.0.1", port: int = 8765):
        self.app = app
        self.host = host
        self.port = port
...
class TestTestingPackage:
    ...
    @pytest.fixture
    def test_app(self):
        """Create test FastASGI application."""
        return TestApp().app
