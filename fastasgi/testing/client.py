"""
TestClient class for executing HTTP requests against FastASGI applications.
"""
...
class TestClient:
    """
    HTTP test client for FastASGI applications.

    Provides a clean interface for testing HTTP endpoints by executing
    TestRequest objects against FastASGI applications and returning
    TestResponse objects.
    """

    def __init__(self, app):
        """
        Initialize TestClient with a FastASGI application.

        Args:
            app: FastASGI application instance
        """
        self.app = app
